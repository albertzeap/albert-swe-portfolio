...
export const About: React.FC<HomeProps> = () => {
    return(
                        ...
                        <Container fluid>
                            <Row className="paragraphs pb-4 mb-5 py-4">
                                ...
                                <Col className="aboutParagraph py-3 gx-5">
                                    ...
                                    <p className="py-1">Over the years, I have picked up several languages and frameworks. Here are some of the languagues I speak:</p>
